...
define("nettle-front-end/components/item-snippet/template", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template((function () {
    return {
      ...
      statements: [["attribute", "class", ["concat", [["get", "item.user", ["loc", [null, [1, 12], [1, 21]]]]]]], ["content", "item.content", ["loc", [null, [1, 25], [1, 41]]]]],
      locals: [],
      templates: []
    };
  })());
...
define('nettle-front-end/components/user-items/component', ['exports', 'ember'], function (exports, _ember) {
  exports['default'] = _ember['default'].Component.extend({});
});
define("nettle-front-end/components/user-items/template", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template((function () {
    var child0 = (function () {
      return {
        meta: {
          ...
          "moduleName": "nettle-front-end/components/user-items/template.hbs"
        },
        isEmpty: false,
        arity: 1,
        cachedFragment: null,
        ...
        statements: [["content", "item.content", ["loc", [null, [4, 2], [4, 18]]]]],
        locals: ["item"],
        templates: []
      };
    })();
    return {
      ...
      statements: [["content", "user.email", ["loc", [null, [1, 0], [1, 14]]]], ["block", "each", [["get", "user.items", ["loc", [null, [3, 8], [3, 18]]]]], [], 0, null, ["loc", [null, [3, 0], [5, 9]]]]],
      locals: [],
      templates: [child0]
    };
  })());
  ...
  exports['default'] = _ember['default'].Route.extend({
    model: function model(params) {
      ...
      return new _ember['default'].RSVP.hash({
        ...
        items: this.store.findRecord('trip', params.trip_id).then(function (trip) {
          return trip.get('items');
        }).then(function (items) {
          return items.sort('users');
        }).then(function (sorted) {
          return console.log(sorted);
        }),
        users: this.store.findAll('user'),
        tripUsers: this.store.findRecord('trip', params.trip_id).then(function (trip) {
          return trip.get('users');
        })
      });
    },
    // items: Ember.computed.sort('model.items',['email:asc']),
    actions: {
...
if (!runningTests) {
  require("nettle-front-end/app")["default"].create({"name":"nettle-front-end","version":"0.0.0+7ff26401"});
}
